...
void init_background() { // INIT BACKGROUND
	...
	draw_button(667, 32, 120, 35, 0x0066CC, "NEXT", 0, SW_Frame);
	draw_button(667, 102, 120, 35, 0x0066CC, "PREV", 0, SW_Frame);
	draw_button(667, 172, 120, 35, 0x0066CC, "COLOR", 0, SW_Frame);
...
if (event == 1) {	//down event
	...
	//Logic for the next & previous & change color buttons
	if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 32
			&& y_mouse <= (32 + 35)) {
		draw_button(667, 32, 120, 35, 0x0066CC, "NEXT", 1, SW_Frame);
		draw_button(667, 102, 120, 35, 0x0066CC, "PREV", 0, SW_Frame);
		draw_button(667, 172, 120, 35, 0x0066CC, "COLOR", 0, SW_Frame);
	}

	else if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 102
			&& y_mouse <= (102 + 35)) {
		draw_button(667, 32, 120, 35, 0x0066CC, "NEXT", 0, SW_Frame);
		draw_button(667, 102, 120, 35, 0x0066CC, "PREV", 1, SW_Frame);
		draw_button(667, 172, 120, 35, 0x0066CC, "COLOR", 0, SW_Frame);
	}

	else if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 172
			&& y_mouse <= (172 + 35)) {
		draw_button(667, 32, 120, 35, 0x0066CC, "NEXT", 0, SW_Frame);
		draw_button(667, 102, 120, 35, 0x0066CC, "PREV", 0, SW_Frame);
		draw_button(667, 172, 120, 35, 0x0066CC, "COLOR", 1, SW_Frame);
	}
